...
train_dir = os.path.join(home_dir,'3D_Slicer','CTPelvic1K', 'inference_weights','nnUNet','rawdata','Task11_CTPelvic1K')

output_dir = os.path.join(home_dir,'3D_Slicer','CTPelvic1K', 'inference_weights','nnUNet','nnUNet_raw','Task11_CTPelvic1K')
...
processed_path = os.path.join(home_dir, '3D_Slicer','CTPelvic1K', 'inference_weights','nnUNet','nnUNet_processed','Task11_CTPelvic1K')
check_save_path = os.path.join(home_dir, '3D_Slicer','CTPelvic1K', 'inference_weights','nnUNet','nnUNet_processed','Task11_CTPelvic1K','Task11_check')
...
"""
test_data_path = os.path.join(home_dir,'3D_Slicer','CTPelvic1K', 'inference_weights','nnUNet','rawdata','ipcai2021_ALL_Test')
